...
wget -O /tmp/ipmi.tat.gz https://github.com/prometheus-community/ipmi_exporter/releases/download/v1.6.1/ipmi_exporter-1.6.1.linux-amd64.tar.gz && cd /tmp && tar -zxvf ipmi.tat.gz && cp /tmp/ipmi_exporter-1.6.1.linux-amd64/ipmi_exporter /bin &&\
rm -rf /tmp/* && \
